...
## Environments
- Preview: https://main--azn-demo-new--aemysites.aem.page/
- Live: https://main--azn-demo-new--aemysites.aem.live/
- Block Library: https://main--azn-demo-new--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `azn-demo-new` directory in your favorite IDE and start coding :)
